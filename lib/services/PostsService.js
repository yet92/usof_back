...
class PostsService {
    ...
    async getAllFiltered(pageNumber, userRole, userId,
                               {
                                   sortBy = 'likes',
                                   filters:
                                       {categoryIds = null,
        ...
        this.#validate({
            ...
            user: validationSchemas.userData.userIdAndRoleSchema(false),
            sortBy: validationSchemas.postData.sortTypes,
            categoryIds: validationSchemas.categoryData.categoryIdsSchema,
        ...
        if (from && to) {
            ...
            if (whereExpr.length) {
                ...
                whereExpr.push(`date(createdAt) between ${formattedFrom} AND ${formattedTo}`);
            }
        }
